...
btn_register = ctk.CTkButton(master=frame,text="Cadastrar",width=250,height=40,corner_radius=15,fg_color="#3053A0",hover_color="#6195F7",border_width=2,border_color="#2D199C",text_color="#19181F",command=abrir_cadastro)
