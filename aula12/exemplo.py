...
btn_login = ctk.CTkButton(master=frame,text="Entrar",width=250,height=40,corner_radius=15,fg_color="#85DA85",hover_color="#AEFFAE",border_width=2,border_color="#64A064",text_color="#181F18",image=icone_user)
